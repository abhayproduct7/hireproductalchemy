...
export const TrustedBrandsSection = () => {
  ...
  const brands = [
    { 
      ...
      className: "translate-y-[-8px] h-8"
    },
    { name: "Indeed", logo: "indeed-logo.png", className: "scale-[2] h-6" },
    { name: "Revolut", logo: "revolut-logo.png", className: "h-8" },
    { name: "Monzo", logo: "monzo-logo.png", className: "h-8" },
    { name: "BCG", logo: "bcg-logo-new.png", className: "h-8" },
    { name: "Meta", logo: "meta-logo-new.png", className: "scale-[2] h-6" },
    { name: "Google", logo: "google-logo-new.png", className: "h-8" },
    { name: "Amazon", logo: "amazon-logo-new.png", className: "h-8" },
  ];
