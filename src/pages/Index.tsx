        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex flex-wrap justify-center items-center gap-8 opacity-75">
              ...
              <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Meta-Logo.png/640px-Meta-Logo.png" alt="Meta" className="h-8 grayscale hover:grayscale-0 transition-all" />
